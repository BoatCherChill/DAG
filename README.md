...
Ошибка "Qt5Core.dll not found":
Скопируйте DLL из папки Qt в папку с программой или скачайте готовую сборку из Releases.

Ошибка "CMake не находит Qt5":
Укажите путь к Qt в CMakeLists.txt
